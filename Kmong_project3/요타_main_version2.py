...
#t1 파라미터 설정
estimator_t1 = XGBClassifier(use_label_encoder= False, subsample= 1.0, objective= 'binary:logistic', min_child_weight=4, max_depth=13, gamma=4 , colsample_bytree= 0.4)
...
X_test_t2 = X_test 
#t2 파라미터 설정
estimator_t2 = XGBClassifier(use_label_encoder= False, subsample= 0.4, objective= 'binary:logistic', min_child_weight= 8, max_depth= 8, gamma=2 , colsample_bytree= 0.9)
